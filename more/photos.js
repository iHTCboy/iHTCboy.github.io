  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/iHTCboy/iGallery/master/Thumbnail/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/iHTCboy/iGallery/master/Backup/' + data.link[i];
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        xhr.open('GET', './photos.json?t=' + +new Date(), true);
